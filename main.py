...
os.environ["OPENAI_API_KEY"] = "sk-proj-UiuYc2bPdJVfZON5DX6ST3BlbkFJxtVD7ZUEGTToaFKcLWIx"
...
def llm_pipeline(file_path):
    ...
    llm_ques_gen_pipeline = ChatOpenAI(openai_api_key="sk-proj-UiuYc2bPdJVfZON5DX6ST3BlbkFJxtVD7ZUEGTToaFKcLWIx")
